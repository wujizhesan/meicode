...
export function createTools(_ctx: ToolContext): Tool[] {
  return [readFileTool, writeFileTool, editFileTool, runCommandTool, findFilesTool, grepCodeTool, shotDiffTool, snapshotTool, rollbackTool, codeIntelTool, browserTool, elicitTool]
}
